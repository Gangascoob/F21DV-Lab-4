...
var circuitmarks = [];
var circuitnames = [];
const circuitidorder = [
  3, 21, 75, 4, 6, 73, 34, 70, 72, 9, 11, 13, 39, 14, 71, 5, 69, 32, 18, 78, 77,
  24,
];
const raceidorder = [
  1052, 1053, 1054, 1055, 1056, 1057, 1059, 1058, 1060, 1061, 1062, 1063, 1064,
  1065, 1066, 1067, 1069, 1070, 1071, 1051, 1072, 1073,
];
...
function nextcircuit() {
  ...
  if (circuitposition > circuitidorder.length - 1) {
    ...
    d3.select("#nextbut").text("");
  } else d3.select("#nextbut").text("Next Round");

  d3.select("#prevbut").text("Previous Round");

  d3.select(".bannertext").text(
    "Formula 1 2021 Season - Round " +
      (circuitposition + 1) +
      " - " +
      circuitnames[circuitposition]
  );
...
function prevcircuit() {
  ...
  if (circuitposition <= 0) {
    d3.select("#prevbut").text("");
    circuitposition = 0;
  } else {
    d3.select("#prevbut").text("Previous Round");
  }

  d3.select("#nextbut").text("Next Round");
